...
function App() {
  ...
  <img
    ...
    height={100}
  />
  <h1 className="display-5 fw-bold  "> Zero Anxiety, Full Confidence: Show Up Ready and Ace your Med School Interview!
  </h1>
  ...
  <input
    type="text"
    className="form-control  z-10   bg-neutral-950 placeholder:text-neutral-700"
    placeholder="Email"
    aria-label="Email"
